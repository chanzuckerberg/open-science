...
**EOSS badge rendered via [shields.io](https://shields.io/)**

The badges in this section fit the spec of [shields.io](https://shields.io/)
and will render nicely with the rest of your badge collection.
The first option is short and sweet:
...
though the inclusion of the logo makes the URL very long.
To use them, right click to copy the image address and replace the linked image in the code snippet above.
...
The following image is slightly larger than most badges but the image is more recognizable:
